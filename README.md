...
Instead of the official Anthropic API, theme generation can also run through cheaperinference.com — set
`THEME_API_PROVIDER=cheaperinference` and provide `CHEAPERINFERENCE_API_KEY`. Leaving `THEME_API_PROVIDER`
