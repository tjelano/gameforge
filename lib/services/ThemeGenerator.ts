...
export interface ThemeGenerator {
  generate(prompt: string, styleId: string, referenceImage?: ReferenceImagePayload, basedOnContent?: string, signal?: AbortSignal, providerOverride?: ProviderOverride): Promise<GeneratedTheme>;
}
...
export class MockThemeGenerator implements ThemeGenerator {
  async generate(prompt: string, _styleId: string, _referenceImage?: ReferenceImagePayload, _basedOnContent?: string, _signal?: AbortSignal, _providerOverride?: ProviderOverride): Promise<GeneratedTheme> {
